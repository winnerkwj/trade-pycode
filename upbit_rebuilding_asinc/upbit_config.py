...
RSI_THRESHOLD           = 10             # 1차 매수 RSI 기준
RSI_CUSTOM_TRIGGER      = 20             # 정밀추매 RSI 기준
...
MIN_INTERVAL_BETWEEN_ADDITIONAL_BUYS = 60     # 추가매수 최소 간격 (초)
