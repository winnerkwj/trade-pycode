...
def _upbit_banned() -> dict[str,str]:
    ...
    try:
        ...
        for item in data:
            ...
            if warn == "CAUTION": reasons[market] = "CAUTION"
            elif state and state.lower() != "active": reasons[market] = state.upper()
    except Exception as e:
        net_err(e)
    return reasons

def fetch_filtered_tickers(origin_list: list[str], cache_sec: int = 900) -> list[str]:
    ...
    if banned:
        ...
        for m in banned: grp[banned_map[m]].append(m)
